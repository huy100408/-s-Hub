...
KeyTab:AddButton({
    ...
    Callback = function()
        local enteredKey = (KeyInput.Value or ""):gsub("%s+", "")  -- FIXED: removed :upper()
        ...
        task.spawn(function()
            if enteredKey == "WashedzHubkey44556677" then
                ...
                Window:Destroy()
                task.wait(1)
                loadstring(game:HttpGet("https://raw.githubusercontent.com/huy100408/-s-Hub/refs/heads/main/mainsource.lua", true))()
            else
